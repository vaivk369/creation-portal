...
let envVariables = {
  ...
  CONTENT_URL: env.sunbird_content_player_url || 'https://dockstaging.sunbirded.org/api/',
  CONTENT_PROXY_URL: env.sunbird_content_proxy_url || 'https://dockstaging.sunbirded.org',
  PORTAL_REALM: env.sunbird_portal_realm || 'sunbird',
  PORTAL_AUTH_SERVER_URL: env.sunbird_portal_auth_server_url || 'https://staging.sunbirded.org/auth',
  PORTAL_AUTH_SERVER_CLIENT: env.sunbird_portal_auth_server_client || 'portal',
  PORTAL_API_AUTH_TOKEN: env.dock_api_auth_token || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJlZTQyM2UwY2NmY2I0N2I0YmU0NzYyZmJlM2I0MWM2YyJ9.oTnuTv_jY2XJmM2nvjLOg8yeQ1MWmGLFnF5NXmB2KOE',
  SUNBIRD_PORTAL_API_AUTH_TOKEN: env.sunbird_api_auth_token || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJKa21PZDJGMzdmak1Vb3ZsdnBZclRCN3ZwTHlTV2dwWiJ9.Te7nCwnpPx5mx0P7cnveXtErMMSuarqALdiS1PFanW0',
  ...
  SUNBIRD_LEARNER_URL: env.sunbird_learner_url || 'https://dockstaging.sunbirded.org/learner',
  DOCK_PROGRAM_SERVICE_URL: env.dock_program_service_url || 'https://dockstaging.sunbirded.org/content/program/',
  ...
  DATASERVICE_URL: env.sunbird_dataservice_url || 'https://dockstaging.sunbirded.org/api/',
  ...
  kp_content_service_base_url: env.sunbird_kp_content_service_base_url || 'https://dockstaging.sunbirded.org/api/',
  kp_learning_service_base_url: env.sunbird_kp_learning_service_base_url || 'https://dockstaging.sunbirded.org/api/',
  kp_assessment_service_base_url: env.sunbird_kp_assessment_service_base_url || 'https://dockstaging.sunbirded.org/api/',
  ...
  sunbird_cloud_storage_secret: env.sunbird_cloud_storage_secret || 'nzng+3OKQQyuDkCVz+TqFVnLIjqCvZcL+Wiio9zXBG9nUXoJ4atnT+u8D7+/IDiqMy6eN72NXkHXgkgvLx6Qqw==',
  ...
  FORM_URL: env.form_url || 'https://dockstaging.sunbirded.org/api/'
}
